...
\setCJKmonofont[Path=src/]{ZhuqueFangsong-Regular.ttf}
\setCJKmainfont[Path=src/, BoldFont={SourceHanSerifSC-Heavy.otf}]{SourceHanSerifSC-Medium.otf}
\title{1978 年至 2018 年中国居民人均\\可支配收入和消费支出的数学模型}
\author{吴承宇 \and 刘湑渊 \and 叶泽宇 \thanks{均为镇海中学在校高二学生. 指导老师为镇海中学在校教师.}}
\date{指导老师: 鲍可宇}
\begin{document}
\maketitle
\abstract{
  改革开放以来, 我国经济持续增长, 人民生活水平不断提高. 人均收入水平是一个重要的宏观经济指标, 也是衡量一个国家经济发展水平的重要指标. 本文通过建立回归模型, 分析了从 1978 年至 2018 年中国居民人均可支配收入和支出的数据, 并且对于 10 年内根据模型简单预测了未来的发展趋势.
}

\textbf{关键词} \quad 数学模型 \quad 非线性回归 \quad 回归模型 \quad 经济指标
...
\begin{itemize}
    \item 感谢鲍可宇老师在数学建模课程中的指导和帮助. 感谢 \texttt{Python}, \texttt{scikit-learn}, \texttt{pandas}, \texttt{matplotlib}, \LaTeX 等开源库.
